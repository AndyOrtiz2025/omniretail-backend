...
public class SecurityConfig {
    ...
    /** Habilita placeholders como {@code {value}} en meta-anotaciones de seguridad ({@link RequirePermission}). */
    @Bean
    static AnnotationTemplateExpressionDefaults annotationTemplateDefaults() {
